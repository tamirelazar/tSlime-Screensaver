 ...
 "candidates": [
  {
   ...
   "tree": [
    "Ground value: L 0.235 (Apple's window gray) or L 0.29 (a step lighter, more visibly gray)",
   ...
   "alternatives": [
    {
     "id": "S1",
     "name": "neutral, darker wall",
     "keys": "0.28,0.04,150@0 0.50,0.12,140@0.45 0.70,0.16,125@0.8 0.90,0.13,105@1",
     "flags": {
      "palette": "#1a2e1e,#1f3d24,#254c28,#2c5c2b,#356b2c,#447c2d,#598d2e,#709e2e,#88af2a,#bbc84f,#ebe377",
      "inner": "1e1e1e",
      "outer": "141414",
      "accent": "6a8b63"
     },
     "rationale": "The reference: neutral L 0.235 ground, wall a step darker. No induced tint; the ring glows outward.",
     "check": "[stop0 L 0.28 vs field L 0.24]"
    },
    {
     "id": "S2",
     "name": "neutral, lighter wall",
     "keys": "0.28,0.04,150@0 0.50,0.12,140@0.45 0.70,0.16,125@0.8 0.90,0.13,105@1",
     "flags": {
      "palette": "#1a2e1e,#1f3d24,#254c28,#2c5c2b,#356b2c,#447c2d,#598d2e,#709e2e,#88af2a,#bbc84f,#ebe377",
      "inner": "1e1e1e",
     ...
     "rationale": "Same ground, wall a step lighter (Apple's underPage gray): the picture as a recessed stage.",
     "check": "[stop0 L 0.28 vs field L 0.24]"
    },
    {
     "id": "S3",
     "name": "warm, darker wall",
     "keys": "0.28,0.04,150@0 0.50,0.12,140@0.45 0.70,0.16,125@0.8 0.90,0.13,105@1",
     "flags": {
      "palette": "#1a2e1e,#1f3d24,#254c28,#2c5c2b,#356b2c,#447c2d,#598d2e,#709e2e,#88af2a,#bbc84f,#ebe377",
      "inner": "221d18",
     ...
     "rationale": "Warm ground (raw-canvas direction). Simultaneous contrast tints the green cooler; Purkinje makes the warm field read darker than its Y in a dim room.",
     "check": "[stop0 L 0.28 vs field L 0.23]"
    },
    {
     "id": "S4",
     "name": "lighter neutral, darker wall",
     "keys": "0.33,0.04,150@0 0.52,0.12,140@0.45 0.71,0.16,125@0.8 0.90,0.13,105@1",
     "flags": {
      "palette": "#263b2a,#2a492e,#2f5631,#346433,#3b7233,#498133,#5e9234,#73a232,#8bb22e,#bdca51,#ebe377",
      "inner": "2c2c2e",
      "outer": "1c1c1e",
      "accent": "6a8b63"
     },
     "rationale": "The ground a step lighter (L 0.29): unmistakably gray, at the cost of a narrower value range for the trails.",
     "check": "[stop0 L 0.33 vs field L 0.29]"
    }
   ]
  },
  {
   "id": "B",
   "title": "Bacon: the snail's trail",
   "chosen": "B2",
   "reason": "B1 is the truer painting and the one that fails the room: a wall at Y 20 % is a lamp, not a ground. B2 keeps Bacon's structure, the flat saturated field outside and the worked flesh figure on raw-canvas brown inside, at a brightness a dark room can hold, and the orange stays orange because its brightness is its luminance. B3's magenta is a second loud colour and its pale ring blends into a beige band over the brown. B4 loses the point: flesh on neutral gray goes dull, and the violet ring belongs to no colour in the picture.",
   ...
   "tree": [
    "Where the saturated field sits: the wall (literal Bacon) or shrunk to the ring on a gray ground",
   ...
   "alternatives": [
    {
     "id": "B1",
     "name": "orange field, literal",
     "keys": "0.27,0.03,45@0 0.38,0.06,40@0.2 0.52,0.09,35@0.4 0.68,0.10,40@0.6 0.84,0.06,60@0.8 0.95,0.02,80@1",
     "flags": {
      "palette": "#33221a,#482c21,#5e3729,#794636,#955545,#b16b56,#cd8369,#dba383,#e9c2a4,#eed8c0,#f6ede0",
      "inner": "2d1e14",
      "outer": "cf5604",
      "accent": "fa6e1d"
     },
     "rationale": "Raw-canvas ground inside, the flat cadmium field outside, an orange ring. The most likely to look like a painting and the most likely to fail the harsh-ground test: the wall is Y 20 %.",
     "check": "[stop0 L 0.27 vs field L 0.25]"
    },
    {
     "id": "B2",
     "name": "orange field, dimmed",
     "keys": "0.27,0.03,45@0 0.38,0.06,40@0.2 0.52,0.09,35@0.4 0.68,0.10,40@0.6 0.84,0.06,60@0.8 0.95,0.02,80@1",
     "flags": {
      "palette": "#33221a,#482c21,#5e3729,#794636,#955545,#b16b56,#cd8369,#dba383,#e9c2a4,#eed8c0,#f6ede0",
      "inner": "2d1e14",
     ...
     "rationale": "The same structure with the field dimmed to L 0.42 for a dark room; the orange stays orange (a weak Helmholtz-Kohlrausch hue, its brightness is its luminance).",
     "check": "[stop0 L 0.27 vs field L 0.25]"
    },
    {
     "id": "B3",
     ...
     "rationale": "Bacon's other field, magenta, at L 0.45: a strong H-K hue, so it reads brighter than its Y. The ring is a thin pale flesh-white line, the space-frame.",
     "check": "[stop0 L 0.27 vs field L 0.25]"
    },
    {
     "id": "B4",
     "name": "gray ground, violet ring",
     "keys": "0.27,0.02,45@0 0.36,0.05,40@0.2 0.50,0.09,35@0.4 0.66,0.10,40@0.6 0.82,0.07,60@0.8 0.94,0.02,80@1",
     "flags": {
      "palette": "#2f231e,#412c23,#543429,#714133,#8f4f3f,#aa6551,#c67c63,#d79b7a,#e7ba97,#ebd3b8,#f2eadd",
      "inner": "1e1e1e",
      "outer": "141414",
      "accent": "6928b0"
     },
     "rationale": "Bacon on the owner's gray: the saturated field shrinks to the ring. Violet at Y 8 % reads as a light source (H-K) without lifting the room; over a neutral field its 75/50 % blends stay violet.",
     "check": "[stop0 L 0.27 vs field L 0.24]"
    }
   ]
  },
  {
   "id": "M",
   "title": "Monet: the envelope",
   "chosen": "M1",
   "reason": "M1 carries the 1905 palette across the whole ramp: violet-blue shadow, cobalt, viridian, madder pink and a lead-white core, each visible in the network, with the cores reading as light coming through white. M2's low chroma reads as dust rather than sunlit stone at this size; the near-value hue test half-succeeds in M3 (the network reads, and luminously) but the cores vanish and the ring disappears, so the picture has no light source. M4's lighter ground and wall wash the field toward the trails' own values and the envelope loses depth.",
   ...
   "tree": [
    "Which envelope: water and shadow (violet-blue, cobalt, viridian, pink, lead white) or Rouen at sunset (mauve, beige, pink, yellow)",
   ...
   "alternatives": [
    {
     "id": "M1",
     "name": "water and shadow",
     "keys": "0.27,0.016,274@0 0.36,0.08,275@0.2 0.50,0.10,240@0.4 0.63,0.08,165@0.6 0.78,0.08,350@0.8 0.92,0.04,85@1",
     "flags": {
      "palette": "#24262e,#2a304a,#313867,#2e5080,#1f6a96,#1b858d,#57997d,#bc9a66,#dfa3bf,#f2c1b2,#f1e3c7",
      "inner": "1e2028",
      "outer": "14161c",
      "accent": "ddaec3"
     },
     "rationale": "Violet-blue shadow through cobalt and viridian to a madder pink and a lead-white core; the hue path goes the long way round through green. Ring: pale rose.",
     "check": "[stop0 L 0.27 vs field L 0.24]"
    },
    {
     "id": "M2",
     "name": "Rouen, end of day",
     "keys": "0.27,0.015,291@0 0.40,0.06,301@0.2 0.56,0.06,19@0.4 0.72,0.07,54@0.6 0.86,0.09,80@0.8 0.96,0.03,88@1",
     "flags": {
      "palette": "#26252d,#383348,#4d4063,#755068,#956666,#b07f71,#c8997b,#deb183,#f0cb8d,#f4dfb4,#faf1dc",
      "inner": "201f27",
      "outer": "16151a",
      "accent": "d2b373"
     },
     "rationale": "The Marmottan's description of the cathedral: pink, beige and yellow with mauves and blues in the shadows. Max chroma 0.09: the near-value hue contrast test.",
     "check": "[stop0 L 0.27 vs field L 0.24]"
    },
    {
     "id": "M3",
     "name": "haze: hue alone",
     "keys": "0.30,0.06,290@0 0.40,0.09,250@0.25 0.48,0.09,180@0.5 0.55,0.10,120@0.75 0.62,0.10,60@1",
     "flags": {
      "palette": "#2e284a,#2d345d,#24426e,#005276,#00606b,#006d5f,#30754e,#58793b,#7b7a2b,#9a782e,#b27744",
      "inner": "1e2028",
      "outer": "14161c",
      "accent": "756d86"
     },
     "rationale": "Lightness held to 0.30-0.62 while hue sweeps violet to blue to green to warm: the extreme of Monet's mechanism. If it reads as mud at a distance, Albers' vanishing boundaries has won and the value steps need widening.",
     "check": "[chroma clipped at stops [4, 5]] [stop0 L 0.30 vs field L 0.24]"
    },
    {
     "id": "M4",
     "name": "water on a light warm ground",
     "keys": "0.37,0.02,274@0 0.45,0.08,275@0.2 0.56,0.10,240@0.4 0.68,0.08,165@0.6 0.82,0.08,350@0.8 0.94,0.04,85@1",
     "flags": {
      "palette": "#3c3f4b,#424866,#485181,#436598,#347ca9,#33969e,#66a88c,#caa874,#edafcb,#fccbbc,#f8eace",
      "inner": "343029",
      "outer": "3e3a34",
      "accent": "ddaec3"
     },
     "rationale": "The same water envelope on a lighter warm gray with a lighter wall still: the light priming showing through, within what a screensaver ground can be.",
     "check": "[stop0 L 0.37 vs field L 0.31]"
    }
   ]
  },
  {
   "id": "G",
   "title": "Gauguin: a plane surface covered with colours",
   "chosen": "G1",
   "reason": "G1 is the Vision: an arbitrary vermilion ground chosen for feeling, held as dark as the gray, the most beautiful green rising to chrome yellow, a blue contour for the ring. It is the strongest picture in the round and the one most at odds with the brief's gray ground, which the owner should weigh. G2 moves the red to the wall, where at L 0.40 it shouts more than G1's dark field does. G3 confirms the fear: tube colours at braille scale read as striped noise, not flat colour. G4, the Fontainas chord, is the most wearable theme of the four and the runner-up: violet-blue faint half, orange cores, on a cool gray.",
   ...
   "tree": [
    "Which picture: the Vision after the Sermon (vermilion field, the green tree) or the Talisman (tube colours on a neutral) or the Fontainas chord (orange/blue linked by yellow/violet)",
   ...
   "alternatives": [
    {
     "id": "G1",
     "name": "the Vision: vermilion ground",
     "keys": "0.30,0.08,30@0 0.38,0.12,275@0.25 0.55,0.15,150@0.5 0.72,0.16,120@0.75 0.88,0.16,95@1",
     "flags": {
      "palette": "#4f1b14,#561d42,#462d70,#004d88,#006c70,#05893e,#529a35,#82ab2a,#acb926,#d3c831,#f9d544",
      "inner": "43100a",
      "outer": "2f0b07",
      "accent": "28467d"
     },
     "rationale": "The ground is the Vision's vermilion held as dark as the gray (as red as sRGB allows at L 0.26); the trails rise from blue through the most beautiful green to chrome yellow; the ring is the dark blue contour, lifted to L 0.40 so it separates from the field.",
     "check": "[chroma clipped at stops [3, 4]] [stop0 L 0.30 vs field L 0.26]"
    },
    {
     "id": "G2",
     "name": "the Vision: vermilion wall",
     "keys": "0.27,0.03,30@0 0.38,0.12,275@0.25 0.55,0.15,150@0.5 0.72,0.16,120@0.75 0.88,0.16,95@1",
     "flags": {
      "palette": "#34211e,#482239,#442e6a,#004d88,#006c70,#05893e,#529a35,#82ab2a,#acb926,#d3c831,#f9d544",
      "inner": "221d18",
      "outer": "831b11",
      "accent": "28467d"
     },
     "rationale": "The same colours with the vermilion moved to the wall and a warm gray ground inside: the sim keeps the focus, the flat red becomes the surround.",
     "check": "[chroma clipped at stops [3, 4]] [stop0 L 0.27 vs field L 0.23]"
    },
    {
     "id": "G3",
     "name": "the Talisman: tube colours",
     "keys": "0.27,0.0,0@0 0.40,0.16,300@0.22 0.58,0.20,30@0.45 0.66,0.15,80@0.6 0.74,0.17,140@0.78 0.89,0.155,96@1",
     "flags": {
      "palette": "#262626,#4b2645,#582781,#8b2584,#c42754,#d05900,#be8700,#a1a900,#7bc652,#c0d144,#f9da50",
      "inner": "1e1e1e",
      "outer": "141414",
      "accent": "e62e1e"
     },
     "rationale": "Denis's list as the stops: violet, vermilion, an ochre bridge, Veronese green, chrome yellow, on a neutral gray, with a vermilion ring. Whether braille dots optically mix these into flat colour or into noise is the thing to judge.",
     "check": "[chroma clipped at stops [5, 6, 7]] [stop0 L 0.27 vs field L 0.24]"
    },
    {
     "id": "G4",
     "name": "the Fontainas chord",
     "keys": "0.28,0.06,280@0 0.42,0.14,265@0.3 0.60,0.15,60@0.6 0.78,0.17,75@0.85 0.92,0.14,95@1",
     "flags": {
      "palette": "#232546,#282f60,#2a3a7c,#264698,#7d3e92,#b2425e,#bc6800,#d38000,#e99800,#faba2c,#ffe47c",
      "inner": "1b1e24",
      "outer": "14161c",
      "accent": "c9690c"
     },
     "rationale": "Orange and blue linked by yellows and violets: violet shadow, blue, then across to orange and a yellow core, on a cool gray; the ring is the chord's orange.",
     "check": "[chroma clipped at stops [6, 7, 8, 10]] [stop0 L 0.28 vs field L 0.23]"
    }
   ]
  },
  {
   "id": "N",
   "title": "Nocturne: built for the dark room",
   "chosen": "N4",
   "reason": "The concept says widen the value steps for a dark room, and N4 is that instruction carried out: the faint half is legible where N1 and N2 keep it at the edge of the mesopic floor, and the near-white core gives the picture a light source without touching the ring. N1 is the same idea, quieter. N3's warm ground is handsome and Itten is right that cold-warm is the most sonorous contrast, but it is a second concept fighting the first (one cool key), and it converges on S3.",
   ...
   "tree": [
    "Ground: cool gray (the palette's own family), neutral, or warm (Chevreul: a warm ground induces coolness into the trails, which this palette wants)",
   ...
   "alternatives": [
    {
     "id": "N1",
     "name": "cool ground",
     "keys": "0.28,0.07,290@0 0.42,0.14,270@0.25 0.58,0.13,230@0.5 0.76,0.11,200@0.75 0.94,0.05,180@1",
     "flags": {
      "palette": "#292149,#302e67,#333c88,#2851a1,#006caf,#0086b1,#00a0bf,#2fbac9,#66d0d1,#9ae4dc,#c8f7ec",
      "inner": "1b1e24",
      "outer": "14161c",
      "accent": "6b2094"
     },
     "rationale": "Everything in one cool key; the only tint induced is warmth, which the violet resists.",
     "check": "[chroma clipped at stops [4, 5, 6]] [stop0 L 0.28 vs field L 0.23]"
    },
    {
     "id": "N2",
     "name": "neutral ground",
     ...
     "rationale": "The same palette on the neutral gray: the trails' hues left exactly where the palette put them.",
     "check": "[chroma clipped at stops [4, 5, 6]] [stop0 L 0.28 vs field L 0.24]"
    },
    {
     "id": "N3",
     "name": "warm ground",
     ...
     "rationale": "Cold-warm contrast, Itten's most sonorous: a warm ground under a cold palette, so the trails read cooler and the field warmer and darker (Purkinje).",
     "check": "[chroma clipped at stops [4, 5, 6]] [stop0 L 0.28 vs field L 0.23]"
    },
    {
     "id": "N4",
     "name": "cool ground, wider steps",
     "keys": "0.32,0.08,290@0 0.50,0.15,270@0.25 0.66,0.13,230@0.5 0.82,0.10,200@0.75 0.97,0.04,180@1",
     "flags": {
      "palette": "#332a58,#3e3b7d,#434fa4,#3b68c0,#2485cc,#09a0d2,#32b7d7,#58cddb,#84e0e0,#b1f0e9,#d9fff6",
      "inner": "1b1e24",
      "outer": "14161c",
      "accent": "6b2094"
     },
     "rationale": "The dark end lifted and spread for a dark room: stop 0 at L 0.32, the mids brighter, the core near white.",
     "check": "[stop0 L 0.32 vs field L 0.23]"
    }
   ]
  }
 ],
